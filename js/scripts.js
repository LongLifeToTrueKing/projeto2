function getMenuBarSession() {
    return sessionStorage.getItem('menuBar') || 'opened'
}

function openMenuBar() {
    $('body').removeClass('sidebar-hide')
    $('#menubar-toggler').removeClass('is-active')
    sessionStorage.setItem('menuBar', 'opened')
}

function closeMenuBar(saveOnSession = true) {
    $('body').addClass('sidebar-hide')
    $('#menubar-toggler').addClass('is-active')
    $('.sidebar').css('position', 'fixed')
    if (saveOnSession)
        sessionStorage.setItem('menuBar', 'closed')
}
...
(function($) {
    ...
    $(document).ready(function() {
        $('#menubar-toggler').on('click', () => {
            const isActive = () => !$('body').hasClass('sidebar-hide');
            if (isActive())
                closeMenuBar()
            else
                openMenuBar()
